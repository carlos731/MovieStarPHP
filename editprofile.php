<?php
    ...
    $userData = $userDao->verifyToken(true); // true: faz com que a pagina editprofile.php só seja acessada com token de autenticação
        ...
        <div class="row" id="change-password-container">
            <div class="col-md-4">
                ...
                <form action="<?= $BASE_URL ?>user_process.php" method="POST">
                    ...
                    <!-- <input type="hidden" name="id" value="<?= $userData->id ?>" Não é necessário mais /> -->
                    <div class="form-group">
