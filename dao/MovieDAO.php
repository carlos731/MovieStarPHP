<?php
    ...
    class MovieDAO implements MovieDAOInterface {
        ...
        public function findByTitle($title){
            ...
            $stmt->bindValue(":title", '%'.$title.'%'); // tropa de elite -> DE, TROPA, ELITE
        ...
        public function update(Movie $movie){
            ...
            // Mensagem de sucesso por atualizar o filme
            $this->message->setMessage("Filme atualizado com sucesso!", "success", "dashboard.php");

        }
        
        public function destroy($id){
            // 1. Remover referências do filme em outras tabelas (se necessário), 
            // para poder depois remover o filme
